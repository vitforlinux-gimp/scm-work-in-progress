...
;;;;create the age-layer layer    
	(set! age-layer (car (gimp-layer-new image width height RGBA-IMAGE "Aging-Layer" 100 SCREEN-MODE)))
    (gimp-image-add-layer image age-layer -1)
...
;;;;create the background layer    
	...
	(if (= bkg-fill TRUE) (gimp-drawable-fill bkg-layer BACKGROUND-FILL))
...
;;;;check that a selection was made if not make one	
	...
	(if (= (car (gimp-selection-is-empty image)) TRUE) (gimp-selection-layer-alpha image-layer))
