...
(define (Aply-script-fu-Liquid-Water-210 img Bump-Layer Back-color ShapeW DropsA LightA sh-op inter)
...
(define (script-fu-Liquid-Water-210-logo-alpha img Bump-Layer Back-color  ShapeW DropsA LightA shopacity interact)
(begin
         (Aply-script-fu-Liquid-Water-210 img Bump-Layer Back-color ShapeW DropsA LightA shopacity interact)
         (gimp-displays-flush)))

(script-fu-register "script-fu-Liquid-Water-210-logo-alpha"
		    _"Liquid-Water 210 ALPHA"
		    "Liquid-Water effect"
...
(script-fu-menu-register "script-fu-Liquid-Water-210-logo-alpha"
			 "<Image>/Script-Fu/Alpha-to-Logo")

(define (script-fu-Liquid-Water-210-logo font size text justify letter-spacing line-spacing Back-color ShapeW DropsA LightA shopacity interact )
  ...
  (let* ((img (car (gimp-image-new 256 256  RGB)))	; nouvelle image -> img
   ...
   (gimp-text-layer-set-line-spacing text-layer line-spacing)      ; Set Line Spacing
	 (gimp-context-push)
    (Aply-script-fu-Liquid-Water-210 img text-layer Back-color ShapeW DropsA LightA shopacity interact)
     (gimp-context-pop)
    (gimp-image-undo-enable img)
    (gimp-display-new img)    
    ))
                    
(script-fu-register 	"script-fu-Liquid-Water-210-logo"
			"Liquid Water 210 LOGO"
...
(script-fu-menu-register "script-fu-Liquid-Water-210-logo"
