...
(let* ((Highlight_up   (car (gimp-layer-copy Bump-Layer FALSE)))
    ...
    (plug-in-lighting 
                       0 img Highlight_up Highlight_up  Highlight_up FALSE FALSE FALSE 0 White 
                       -1 -1 1 -4 -0 1 LightA 
    ...
    (gimp-drawable-edit-clear  Highlight_down)
        (gimp-selection-none img)
    (plug-in-lighting 
                       0 img Mosaic_calque Mosaic_calque Mosaic_calque  1 FALSE FALSE 0 White 
                       -1 -1 1 -4 -0 1 LightA 
...
(script-fu-register "script-fu-Liquid-Water-logo-alpha"
		    _"<Image>/Filters/Alpha to Logo/Liquid-Water"
		    "Liquid-Water effect"
