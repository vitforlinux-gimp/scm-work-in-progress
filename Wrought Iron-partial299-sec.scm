...
;;;;create selection-channel (gimp-image-select-item image 2 selection-channel)
   ...
   ; (gimp-image-set-active-layer image image-layer)	; qui
...
;;;;create original-selection-channel if a selection exists (gimp-image-select-item image 2 original-selection-channel)
    (if (= sel FALSE) (begin
    (gimp-selection-save image)
